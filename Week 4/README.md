📄 Digital Marketing Campaign – Social Connect
Improve reach, engagement, and conversions using retargeting ads.

📊 Previous Work
Created social media posts, ads, and defined target audience.

🔁 Retargeting Ads
Targeted users who visited but didn’t sign up.
...
In this week, I worked on a Content Distribution project where I repurposed my content and shared it on different platforms like LinkedIn.

The goal was to understand how content can be reused and distributed to reach a wider audience.

What I did
Created content for my project
Repurposed it for different platforms
Shared posts on LinkedIn
Took screenshots as proof

LinkedIn Posts (Proof)
